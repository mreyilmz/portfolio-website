  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="font-bold"> a full-stack web developer</span>, leaning
        front-end, with <span className="font-bold">2 years</span> of
        experience. You can find my <span className="italic">projects</span> on
        this site and <span className="underline">github</span>.
      </motion.h1>
